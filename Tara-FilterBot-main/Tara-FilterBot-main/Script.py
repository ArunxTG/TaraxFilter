...
ᴍʏ ɴᴀᴍᴇ ɪꜱ <a href=https://t.me/{}>TARA × BoT</a>,
...
ʜᴇʀᴇ ɪꜱ ᴛʜᴇ ʜᴇʟᴩ ꜰᴏʀ ᴍʏ ᴄᴏᴍᴍᴀɴᴅꜱ.
    ...
    ABOUT_TXT = """
╭────[ TARA × BoT ]────⍟
├⍟ ᴍᴇʜ ɴᴀᴍᴇ : <a href='http://t.me/Itz_Tarabot'>TARA × BoT</a>
├⍟ ᴏᴡɴᴇʀ : <a href='https://t.me/its_Raavanan'>ꪆࣼꪒവᰢ͟།ᰈ།ໍ</a>
├⍟ ᴠᴇʀsɪᴏɴ : <a href='https://t.me/MRxBotzz'>ᴍʀ x 7.1</a>
├⍟ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a>
├⍟ ꜰʀᴀᴍᴇᴡᴏʀᴋ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a>
├⍟ ᴅᴀᴛᴀʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a>
├⍟ ʜᴏsᴛᴇᴅ ᴏɴ : <a href='https://t.me/MRxBotzz'>ᴍʀ x sᴇʀᴠᴇʀ</a>
...
» ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ : <a href='https://t.me/MR_X_MIRROR'>ʜᴇʀᴇ</a>

▸ ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ
▸ ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ʟɪᴋᴇ ᴛʜɪꜱ ʙᴏᴛ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ..!
▸ ɪ ᴡɪʟʟ ᴄʀᴇᴀᴛᴇ ᴀ ʙᴏᴛ ꜰᴏʀ ʏᴏᴜ

▸ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ : <a href=https://t.me/MR_X_MIRROR>ᴍʀ x ᴍɪʀʀᴏʀ</a> </b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/MRxBotzz)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
<b>᚛› ᴀᴅᴅᴇᴅ ʙʏ » {} </b>
<b>᚛› <a href='http://t.me/Itz_Tarabot'>TARA × BoT</a></b>"""
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    SHORTLINK_INFO = """
<b>──────「<a href=https://t.me/MRxBotzz> Hᴏᴡ ᴛᴏ Eᴀʀɴ Mᴏɴᴇʏ </a> 」──────
...
sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href=https://t.me/MRxBotzz> ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ </a>Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>ᴍʀx.7.1 [ Sᴛᴀʙʟᴇ ]</code></b>"""
